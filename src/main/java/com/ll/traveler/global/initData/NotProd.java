...
public class NotProd {
    ...
    public  void work1() {
        ...
        Member user1 = memberService.join("MEMBER","user1", "1234", "user1@test.com","","").getData();
        Member user2 = memberService.join("MEMBER","user2", "1234", "user2@test.com","","").getData();
        Member user3 = memberService.join("MEMBER","user3", "1234", "user3@test.com","","").getData();
